...
def generate_report():
    ...
    # Let's pivot: Rule x Degree x Width (take max success rate over depths? or average?)
    # "populate success rate heat maps across depths and widths"
    # Maybe fix Degree and plot Depth vs Width?
    ...
    with open('comparative_experiments/results.md', 'w') as f:
        ...
        for rule in rules:
            ...
            # Heatmap: Width vs Depth for each Degree
            for deg in degrees:

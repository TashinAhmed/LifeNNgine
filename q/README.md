...
```
python src/cann/train.py -d -s -e 125000 -l 0.001 -m 1 -r 128 -b 8 8 -a PReLU -t -x prelu_act_knockout
```

L(1,1) PReLU experiment with no learning on neural weights

```
python src/cann/train.py -d -s -e 125000 -l 0.001 -m 1 -r 128 -b 8 8 -a PReLU -w -x prelu_neuron_knockout
```

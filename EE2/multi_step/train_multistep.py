...
def train_multistep(steps, device='cpu', epochs=150):
    ...
    for epoch in range(epochs):
        ...
        if epoch % 10 == 0 or epoch == epochs - 1:
            ...
            with torch.no_grad():
                ...
                # Full grid evaluation (no cropping)
...
def run_experiment():
    ...
    with open('EE2/multi_step/results.json', 'w') as f:
    ...
    plt.grid(True)
    plt.ylim(-0.1, 1.1)
    plt.savefig('EE2/multi_step/accuracy_plot.png')
    print("Results saved to EE2/multi_step/")
